...
func NewGoogleProvider(clientID, clientSecret, redirectURI string) *GoogleProvider {
	...
	// Support custom OAuth endpoints for testing
...
func (p *GoogleProvider) UserInfo(ctx context.Context, token *oauth2.Token, allowedDomains, _ []string) (*UserInfo, error) {
