...
type Provider interface {
	...
	// allowedOrgs is used for organization-based access control (GitHub).
	UserInfo(ctx context.Context, token *oauth2.Token, allowedDomains, allowedOrgs []string) (*UserInfo, error)
}
